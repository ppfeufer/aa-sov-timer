...
```shell
pip install aa-sov-timer==5.1.1
```
...
[![Translation status](https://weblate.ppfeufer.de/widget/alliance-auth-apps/aa-sov-timer/matrix-auto.svg)](https://weblate.ppfeufer.de/engage/alliance-auth-apps/)
